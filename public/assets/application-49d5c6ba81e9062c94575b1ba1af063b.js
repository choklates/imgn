...
(function() {
  var convertCanvasToImage;

  $(function() {
    return $('input.js-text').on('keyup', function() {
      $('button.js-button').text($(this).val());
      return html2canvas($('.js-button'), {
        onrendered: function(canvas) {
          var $image;
          $image = $('<img>', {
            src: convertCanvasToImage(canvas)
          });
